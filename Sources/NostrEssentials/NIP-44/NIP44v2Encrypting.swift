...
public extension NIP44v2Encrypting {
    ...
    func encrypt(plaintext: String, privateKeyA: Data, publicKeyB: Data) throws -> String {
    ...
    func decrypt(payload: String, privateKeyA: Data, publicKeyB: Data) throws -> String {
        let conversationKey = try conversationKey(privateKeyA: privateKeyA, publicKeyB: publicKeyB)
...
extension NIP44v2Encrypting {
    ...
    private func preparePublicKeyBytes(from publicKey: Data) throws -> [UInt8] {
        let publicKeyBytes = toBytes(from: publicKey)
    ...
    func conversationKey(privateKeyA: Data, publicKeyB: Data) throws -> ContiguousBytes {

        let privateKeyABytes = toBytes(from: privateKeyA)
