...
public struct RequestPlan {
    ...
    let findEventsRequests: [String: FindEventsRequest]
}
...
public func createRequestPlan(pubkeys: Set<String>,
                       ...
                       preferredRelays: PreferredRelays) -> RequestPlan {
...
public struct WritePlan {
    ...
    let relays: [String: Set<String>] // [relay: pubkeys]
}
